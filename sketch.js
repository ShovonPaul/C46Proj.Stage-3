...
function preload(){
  ...
  deer_run = loadAnimation("./assets/deer1.png","./assets/deer2.png","./assets/deer3.png",
  "./assets/deer5.png",);
...
function spawnDeers(){
  if(frameCount % 240 === 0){
  deer = createSprite(600,270,40,40);
  deer.addAnimation("running",deer_run)
  deer.velocityX = -2
  deer.scale = 0.5
  deersGroup.add(deer)
}
